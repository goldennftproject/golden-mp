...
ok("una confirmación larga de correo se desplaza dentro de la puerta baja", /#gate \.gcard\{max-height:calc\(100vh - 32px\);overflow-y:auto;overscroll-behavior:contain\}/.test(css));
