...
El proyecto tiene 94 pruebas automáticas y 22 auditores y medidores (116 herramientas en total). No comprueban que el código compile: comprueban que el JUEGO cumpla las reglas de arriba. Los más útiles para el diseñador:
