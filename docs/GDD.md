...
El proyecto tiene 90 pruebas automáticas y 18 auditores (134 herramientas en total). No comprueban que el código compile: comprueban que el JUEGO cumpla las reglas de arriba. Los más útiles para el diseñador:
