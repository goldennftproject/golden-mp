...
El proyecto tiene 95 pruebas automáticas y 28 auditores y medidores (123 herramientas en total). No comprueban que el código compile: comprueban que el JUEGO cumpla las reglas de arriba. Los más útiles para el diseñador:
