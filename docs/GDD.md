...
El proyecto tiene 62 pruebas automáticas y 16 auditores (102 herramientas en total). No comprueban que el código compile: comprueban que el JUEGO cumpla las reglas de arriba. Los más útiles para el diseñador:
