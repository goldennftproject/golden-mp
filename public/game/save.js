...
function snapshot() {
  return { plata: G.plata, golden: G.golden, level: G.level, prestige: G.prestige, week: G.week,
    ...
    planos: G.planos, obras: G.obras, obraDep: G.obraDep, capsClaim: G.capsClaim, emergBuys: G.emergBuys, capVisto: G.capVisto };   // blueprints (12/8) · capítulos + capataz + emergencia (14/8)
}
...
function hydrate(d) {
  ...
  if (d.capVisto && typeof d.capVisto === "object") G.capVisto = d.capVisto;       // líneas del capataz ya dichas (14/8)
